...
/* Prompts a person that the next thing they need to do to finish connecting their Smart TV and GMRIGHT application is to navigate to their Facebook application on their mobile device and look through their notifications for a message about the connection being formed */

"DeviceLogin.SmartLogInPrompt" = "若要連結帳號，請從行動裝置開啟 GMRIGHT 應用程式，並查看通知。";
...
"ErrorRecovery.Login.Suggestion" = "請重新登入此應用程式以重新連結您的 GMRIGHT 帳號。";
...
"LoginButton.LoggedIn" = "已使用 GMRIGHT 登入";
...
/* The label for the GMRIGHTSDKLoginButton when the user is currently logged in */
